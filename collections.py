...
# se puede modificar después de creada
...
# la forma de acceder a los elementos es por índices, el primer índice es el 0
...
# Películas
peliculas = [
    "Titanic", "Avatar", "El Padrino", "Pulp Fiction", "Forrest Gump", "Matrix", "Interestelar",
    "Jurassic Park", "La La Land", "Star Wars: Episodio IV - Una nueva esperanza",
    "Harry Potter y la piedra filosofal", "Los Vengadores", "Gladiador",
    "El Señor de los Anillos: La Comunidad del Anillo", "El Rey León", "Batman: El Caballero de la Noche",
    "E.T. el Extraterrestre", "Toy Story", "Mad Max: Furia en la carretera", "Inception",
    "El Resplandor", "El Silencio de los Corderos", "Coco", "Rocky", "La La Land", "Buscando a Nemo"
]
...
comidas_mexicanas = [
    "Tacos", "Tamales", "Enchiladas", "Tacos", "Pozole", "Guacamole", "Chiles en Nogada",
    "Tamales", "Chiles Rellenos", "Sopes", "Pozole", "Tacos", "Enchiladas", "Chiles en Nogada",
    "Chiles Rellenos", "Tortas Ahogadas", "Tostadas", "Tacos", "Tlacoyos", "Sopes"
]
